    ...
    <form action="" method="post">
        <div class="row">
            <div class="col-md-6 offset-md-3">
                <a href="/teacher/vacation/<?= $teacher_id ?>" class="btn btn-warning my-2 px-4"><i class="fas fa-chevron-left"></i></a>
            </div>
            <div class="col-md-6 offset-md-3">
                ...
                <div class="form-group">
                    <textarea name="reason" class="form-control form-control-lg" rows="5" required placeholder="<?= $text_reason ?>"><?= $this->showValue('reason') ?></textarea>
                </div>
                <div class="form-group">
