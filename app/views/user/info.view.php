<div class="container">
    ...
    <h2 class="h1 text-warning text-center pt-0"><?= $user->username ?></h2>
    <div class="row user_info_section">
        <div class="col-12">
            <a href="<?= isset($_SERVER['HTTP_REFERER']) ? $_SERVER['HTTP_REFERER'] : '/user' ?>" class="btn btn-warning my-2 px-4"><i class="fas fa-chevron-left"></i></a>
        </div>
        <div class="col-md-12">
        ...
        <div class="col-md-12 py-3">
            <div class="form-group">
                <a href="/user/edit/<?= $user->user_id ?>" class="btn btn-block btn-lg btn-success"><i class="fas fa-edit"></i> <?= $text_edit ?></a>
            </div>
            <div class="item pb-2">
                <div class="row">
