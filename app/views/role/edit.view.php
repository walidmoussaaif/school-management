<div class="container">
    <h1 class="text-center"><?= $text_header . ' "' . $role->role . '"' ?></h1>
    <form method="post">
        <div class="row">
            <div class="col-12">
            ...
            <div class="col-md-5">
                <div class="form-group">
                    <input value="<?= $this->showValue('role',$role) ?>" autofocus="autofocus" name="role" type="text" class="form-control form-control-lg" placeholder="<?= $text_role ?>" autocomplete="off" required>
                </div>
                <div class="form-group">
        ...
        <div class="row all_privileges">
            <div class="col-12 pb-2">
                <div class="badge badge-dark p-2"><span class="h5 font-weight-normal"><?= $text_privileges ?></span></div>
            </div>
            <div class="col-12 pb-2">
                ...
                foreach ($privileges as $key => $privilege):
                    ...
                    <div class="col-md-12 pb-4">
                        ...
                        foreach ($privilege as $priv):
                            ...
                            <div class="badge badge-light w-100 p-2 text-left">
                                <div class="custom-control custom-checkbox">
                                    <input <?= in_array($priv->privilege_id,isset($_POST['privileges']) ? $_POST['privileges'] : (!empty($role_privileges) ? $role_privileges : [])) ? 'checked' : '' ?> type="checkbox" name="privileges[]" class="check_item custom-control-input" value="<?= $priv->privilege_id ?>" id="<?= $priv->privilege_id ?>">
