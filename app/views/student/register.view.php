<div class="container register_student no_global_search">
            ...
            <div class="col-md-8 offset-md-2">
                <div class="form-group">
                    ...
                    if(isset($years) && !empty($years)):
                        ...
                        ?>
                            <option <?= $this->selectedIf('school_year_id',$year->school_year_id) ?> value="<?= $year->school_year_id ?>"><?= $year->label ?></option>
                        <?php
                        endforeach;
                    endif;
                    ?>
                ...
                <div class="form-group">
                    <input value="<?= $this->showValue('total_amount') ?>" type="number" name="total_amount" class="form-control form-control-lg" placeholder="<?= $text_amount ?>" required>
                </div>
                <div class="form-group">
                    <select name="group_id" class="form-control form-control-lg" id="group_id" required>
                        ...
                        if(isset($groups) && !empty($groups)):
                            ...
                            ?>
                                <option <?= $this->selectedIf('group_id',$group->group_id) ?> value="<?= $group->group_id ?>"><?= $group->group_name ?></option>
                            <?php
                            endforeach;
                        endif;
                        ?>
    ...
    <div class="row table_groups">
        ...
        <div class="col-md-8 offset-md-2">
            <button form="the_form" type="submit" class="btn btn-success btn-block btn-lg"><?= $text_register ?></button>
        </div>
    </div>
</div>